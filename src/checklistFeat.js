...
export function changeChecklistInputElem(event, toDoObj) {
  ...
  checklistItemElemSub.addEventListener(
    'focusout',
    function editChecklistItem() {
      Object.keys(toDoObj.checklist).forEach((key) => {
        if (toDoObj.checklist[key].labelElemId === checklistItemElemSub.id && checklistItemElemSub.value !== '') {
          ...
          toDoObj.checklist[key].labelElemId === checklistItemElemSub.id &&
          checklistItemElemSub.value === ''
        ) {
...
export function createNewChecklistItem(currentObj, checklistItems, multipleSpacesRegex) {
  ...
  checklistInputElem.addEventListener(
    'focusout',
    () => {
